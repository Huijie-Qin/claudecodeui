...
>(({ className, ...props }, ref) => (
  <textarea
    ...
    className={cn(
      'chat-input-placeholder block min-h-10 max-h-[40vh] w-full resize-none overflow-y-auto bg-transparent px-4 py-2 text-sm leading-6 text-foreground placeholder-muted-foreground/50 focus:outline-none sm:max-h-[300px]',
      className
    )}
    rows={1}
    {...props}
