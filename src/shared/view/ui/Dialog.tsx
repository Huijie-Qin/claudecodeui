...
interface DialogContentProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  /** Class for the portal layer, including both the backdrop and content. */
...
const DialogContent = React.forwardRef<HTMLDivElement, DialogContentProps>(
  ({ className, children, onEscapeKeyDown, onPointerDownOutside, portalClassName, ...props }, ref) => {
    ...
    return createPortal(
      <div className={cn('fixed inset-0 z-50', portalClassName)}>
        {/* Overlay */}
        <div
