...
// POST /:projectName/files/create - Create new file or directory
router.post('/:projectName/files/create', async (req, res) => {
    try {
        const { projectName } = req.params;
...
// PUT /:projectName/files/rename - Rename file or directory
router.put('/:projectName/files/rename', async (req, res) => {
    try {
        const { projectName } = req.params;
...
// DELETE /:projectName/files - Delete file or directory
router.delete('/:projectName/files', async (req, res) => {
    try {
        const { projectName } = req.params;
...
// POST /:projectName/files/upload - Upload files
...
router.post('/:projectName/files/upload', uploadFilesHandler);
    ...
    try {
        ...
        const storage = multer.diskStorage({
            destination: async (req, file, cb) => {
                const uploadDir = path.join(osMod.tmpdir(), 'claude-ui-uploads', String(req.user.id));
